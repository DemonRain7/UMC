...
class TerrainPerlin:
    ...
    def generate_perlin_noise_2d(shape, res):
        ...
        print("Saving old random state before creating terrain:", old_state[1][0])

        # Step 2: 设置新的seed
        np.random.seed(100)  # 设置一个新的seed
        ...
        # 应该与之前保持一致
        print("Old random state restored:", np.random.get_state()[1][0])
