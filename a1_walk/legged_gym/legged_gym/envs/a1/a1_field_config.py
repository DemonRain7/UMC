...
class A1FieldCfgPPO( A1RoughCfgPPO ):
    ...
    class policy( A1RoughCfgPPO.policy ):
        ...
        env_name = "a1"
        mu_activation = "tanh"
        actor_type = "transformer_sms" # TODO: IF transformer_rma_phase2/mlp_tfql, step=50, else step=24!!!!!
        critic_type = "transformer_sms" # TODO: IF transformer_rma_phase2, step=50, else step=24!!!!!
        embedding_dim = 120
        nheads = 2
        nlayers = 4
        dim_feedforward = 128
