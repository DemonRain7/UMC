...
class LeggedRobotField(LeggedRobot):
    ...
    def compute_observations(self):
        ...
        for i in range(self.num_envs):  
            ...
            if self.cfg.obs.dynamic_fault_obs and (dof_index==0 or dof_index==1 or dof_index==2):
            ...
            if self.cfg.obs.dynamic_fault_obs and (dof_index==4 or dof_index==3 or dof_index==5):
                if self.curr_iter > 0:  # 当迭代次数达到阈值后，开始加入损坏
                    # 随机选择不超过3个 DOF
                    # Determine which dof group this environment belongs to
