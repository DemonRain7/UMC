...
class LeggedRobotField(LeggedRobot):
    ...
    def _get_dmg_flag_obs(self, privileged= False):
        return self.dmg_flag
    ...
    def _get_obs_from_components(self, components: list, privileged= False):
        ...
        for k, v in obs_segments.items():
            if k == "proprioception":
                ...
                if k != "mask_obs" and k != "is_dof_limit" and k != "dmg_flag":
                    obs.append(
    ...
    def compute_observations(self):
        ...
        # print("actor obs_buf :", self.obs_buf[:,-1])
    ...
    def _write_dmg_flag_noise(self, noise_vec):
        if not hasattr(self.cfg.noise.noise_scales, "dmg_flag"):
            return
        noise_vec[:] = 0
