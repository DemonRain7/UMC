...
MAPS = { # First index is a list that contains the indices of the observation, the second index is a list that contains the indices of the action 
    ...
    'h1': {
        'left_hip_yaw_joint': [[10, 22, 32], [0]],
        'left_hip_roll_joint': [[11, 23, 33], [1]],
        'left_hip_pitch_joint': [[12, 24, 34], [2]],
        'left_knee_joint': [[13, 25, 35], [3]],
        'left_ankle_joint': [[14, 26, 36], [4]],
        'right_hip_yaw_joint': [[15, 27, 37], [5]],
        'right_hip_roll_joint': [[16, 28, 38], [6]],
        'right_hip_pitch_joint': [[17, 29, 39], [7]],
        'right_knee_joint': [[18, 30, 40], [8]],
        'right_ankle_joint': [[19, 31, 41], [9]],
        'root': [list(range(0,10)), []],
    },
}
