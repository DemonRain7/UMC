...
class LeggedRobot_Unitree(BaseTask_Unitree):
   ...
   #------------- Callbacks --------------
    ...
    def _create_envs(self):
        ...
        if self.cfg.asset.set_dof_limit_flag:
            ...
            for i in range(self.num_envs):
                ...
                num_faulty_dofs = random.randint(2, 4)  # Randomly select the number of DOFs
                faulty_dof_indices = random.sample(range(10), num_faulty_dofs)  # Randomly pick indices from 0 to 11
    ...
    #     lin_vel_error = torch.abs(torch.mean(torch.square(
